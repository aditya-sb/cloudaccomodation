...
const ExploreProperties = () => {
  ...
  return (
    <section className="w-full max-w-screen-2xl mx-auto max-sm:px-4 px-10 py-8">
      <h2 className="text-xl sm:text-2xl mt-4 font-bold text-start mb-4">Explore Properties</h2>
      <p className="text-sm sm:text-base text-gray-600 mb-4">
        You can browse a wide range of affordable, verified, and fully furnished properties that
