  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="relative w-full h-[300px] sm:h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-y-0 left-0 flex flex-col justify-center px-6 sm:px-10 text-white max-w-md sm:max-w-lg">
      ...
      <h2 className="text-3xl sm:text-4xl mt-7 font-extrabold text-center text-white mb-10">
        Explore Properties
      </h2>
      ...
      <section className="relative w-full h-[200px] sm:h-[300px] overflow-hidden">
        <img
