...
export default function PrivacySection() {
    return (
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-8 rounded-xl shadow-lg mx-20 mb-10 flex items-center transition transform hover:scale-105 hover:shadow-2xl">
